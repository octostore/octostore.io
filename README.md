...
```bash
git clone --branch v0.14.1 --depth 1 https://github.com/octostore/octostore.io
cd octostore.io
npm ci --ignore-scripts --no-audit --no-fund
./node_modules/.bin/skills add \
  https://github.com/octostore/octostore.io/tree/v0.14.1 \
  --skill octostore --agent codex -y
```

Or inspect the immutable [v0.14.1 agent-skill release artifact](https://github.com/octostore/octostore.io/releases/download/v0.14.1/octostore-agent-skill.md). It teaches primitive selection, shared bootstrap, the lease loop, supervisor coupling, machine events, exit codes, and the stop-on-loss rule. The hosted [current skill](https://octostore.io/agents/SKILL.md) follows the site and may change between releases.
