...
const immutableSkillArtifact =
  "https://github.com/octostore/octostore.io/releases/download/v0.14.1/octostore-agent-skill.md";
...
if (!homepage.includes(immutableSkillArtifact)) {
  errors.push("index.html: primary agent-skill path must use the immutable v0.14.1 release artifact");
}
...
for (const required of [
  ...
  "immutable v0.14.1 release artifact",
