...
metadata:
  version: 0.14.1
  octostore-cli: ">=0.14.1 <0.15.0"
  octostore-api: ">=0.14.1 <0.15.0"
---
...
Report what you read as `octostore skill 0.14.1`. Check the CLI with `octostore --version`; this skill supports CLI/API `0.14.x`.
